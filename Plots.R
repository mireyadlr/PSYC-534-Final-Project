***Make sure you have the adjusted_pMatrices and the happyData before running code**
...
zlim <- range(adjusted_pMatrices[["meanGDP"]], na.rm = TRUE)
cols <- colorRampPalette(c("darkgreen", "lightgreen", "white", 
                           "skyblue", "navy"))(200)
legend(
  "topleft", 
  legend = round(seq(zlim[1], zlim[2], length.out = 10), 2),
